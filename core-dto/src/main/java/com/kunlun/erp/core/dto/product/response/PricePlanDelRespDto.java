...
/**
 * @ClassName PricePlanDelRespDto
 * @Description 删除价格套餐响应
 * @Author Jm.zhang
 * @Date 2019-12-17 23:11
 * @Version 1.0
 **/
@ApiModel(description = "删除价格套餐结果响应")
public class PricePlanDelRespDto {
    @ApiModelProperty(value = "已删除的成本明细数量",example = "1")
    private int del_cost_count;

    @ApiModelProperty(value = "已删除的价格数量",example = "5")
    private int del_price_count;

    @ApiModelProperty(value = "已删除的价格套餐数量",example = "1")
    private int del_price_plan_count;
    ...
    public int getDel_price_plan_count() {
        return del_price_plan_count;
    }

    public void setDel_price_plan_count(int del_price_plan_count) {
        this.del_price_plan_count = del_price_plan_count;
    }
