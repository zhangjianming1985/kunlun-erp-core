...
public class IdCardVerification {
    ...
    public static String IDCardValidate(String IDStr) {
        ...
        if (RegexUtil.isNumeric(Ai) == false) {
        ...
        if (RegexUtil.isDate(strYear + "-" + strMonth + "-" + strDay) == false) {
     ...
     * @returns {*}
     */
    public static int getGender(String IDStr) {
        if (IDStr.length() == 15) {
            if (Integer.valueOf(IDStr.substring(14, 15)) % 2 == 0) {
                return 2;
            } else {
                return 1;
            }
        } else if (IDStr.length() == 18) {
            if (Integer.valueOf(IDStr.substring(14, 17)) % 2 == 0) {
                return 2;
            } else {
                return 1;
            }
