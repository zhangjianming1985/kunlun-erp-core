...
public class RsaSecure {
    ...
    public static String signature(String res, PrivateKey key) throws Exception {
        ...
        signature.update(res.getBytes(StandardCharsets.UTF_8));
    ...
    private void generateKeyPairString(int keySize) throws Exception {
        ...
        RsaSecure.publicModulus = HexSecure.bytes2Hex(prime.toByteArray());
        RsaSecure.publicExponent = HexSecure.bytes2Hex(exponent.toByteArray());
        ...
        RsaSecure.privateModulus = HexSecure.bytes2Hex(privateModulus.toByteArray());
        RsaSecure.privateExponent = HexSecure.bytes2Hex(privateExponent.toByteArray());
    }
    ...
    public static RSAPublicKey getRSAPublicKey(String hexModulus, String hexPublicExponent) {
        ...
        try {
            modulus = HexSecure.hex2Bytes(hexModulus);
            publicExponent = HexSecure.hex2Bytes(hexPublicExponent);
        } catch (Exception ex) {
    ...
    public static RSAPrivateKey getRSAPrivateKey(String hexModulus, String hexPrivateExponent) {
        ...
        try {
            modulus = HexSecure.hex2Bytes(hexModulus);
            privateExponent = HexSecure.hex2Bytes(hexPrivateExponent);
        } catch (Exception ex) {
    ...
    public static PublicKey getPublicKeyFromX509(String algorithm, String pubkeyString) throws Exception {
        ...
        byte[] encodedKey = pubkeyString.getBytes(StandardCharsets.UTF_8);
    ...
    public static PrivateKey getPrivateKeyFromPKCS8(String algorithm, String privateKeyString) throws Exception {
        ...
        byte[] encodedKey = privateKeyString.getBytes(StandardCharsets.UTF_8);
